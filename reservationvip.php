            ...
            <div class="row justify-content-center">
                <div class="col-md-6">
                    <div class="card mt-5 mb-4">
                        <div class="card">
                            <div class="card-body">
                                <h1 class="card-title text-center">Réservation de place VIP</h1>
                                <?php
                                try {
                                    // Requête SQL pour récupérer le nombre de places disponibles pour les places basiques
                                    $sql = "SELECT nombre_places_disponibles FROM place_disponible WHERE type_place = 'vip'";
                                    $stmt = $conn->query($sql);
                                ...
                                <div class="text-center mb-4">
                                    <img src="theatre3.jpg" class="img-fluid" alt="...">
                                </div>
                                <!-- Formulaire de réservation pour les places basiques -->
                                <form action="traitement_reservation_vip.php" method="post">
