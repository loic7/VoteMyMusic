...
if (isset($_SESSION['connected'])) { // Vérifie si l'utilisateur est connecté
    ...
    try {
        ...
        $sql = "INSERT INTO reservation (type_place, nom, prenom, email) VALUES ('vip', :nom, :prenom, :email)";
        ...
        $sql = "UPDATE place_disponible SET nombre_places_disponibles = nombre_places_disponibles - 1 WHERE type_place = 'vip'";
        $stmt = $conn->prepare($sql);
        $stmt->execute();
